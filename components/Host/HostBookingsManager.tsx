...
const HostBookingsManager = () => {
  const [bookings, setBookings] = useState<Booking[]>([]);
  const [error, setError] = useState("");

  // Fetch bookings for the host's listings
  useEffect(() => {
  ...
  return (
    <div className="mt-8">
      <h2 className="text-2xl font-bold text-my-cocoa-100 mb-4">Host Bookings</h2>
        ...
        <table className="min-w-full text-my-cocoa-50">
          ...
          <tbody>
            {bookings.length > 0 ? (
              ...
              <tr>
                <td colSpan={5} className="py-4 px-4 text-center text-my-cocoa-200">
                  No bookings found.
                </td>
              </tr>
            )}
