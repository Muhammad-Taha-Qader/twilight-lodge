    ...
    <div className="flex items-center justify-between mx-5">
      ...
      <div className="flex-grow max-w-[80%] overflow-x-auto">
        <div className="relative flex whitespace-nowrap">
          ...
          {/* Right arrow
          <button
            className="absolute right-0 top-0 bottom-0 z-10 flex items-center justify-center w-10 bg-gradient-to-l from-white to-transparent hover:from-gray-200"
      ...
      <div className="flex-none max-w-[20%] ml-4 py-8">
        <div className="flex items-center space-x-4 ml-4">
          ...
          <div className="flex items-center space-x-1 px-4 py-2 border rounded-lg hover:border-my-cocoa-200" >
            <span className="">Display total before taxes</span>
            <input type="checkbox" className="toggle-checkbox" />
          </div>
        </div>
      </div>
