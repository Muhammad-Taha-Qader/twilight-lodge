...
const UserControls = () => {
  return (
    <div className="flex items-center space-x-4 md:space-x-2">
      <Link href="/" className="text-sm hover:bg-my-cocoa-500/10 px-6 py-3 rounded-3xl hidden md:block">Twilight your home</Link>
      <div className="px-6 py-3 hover:bg-my-cocoa-500/10 rounded-3xl hidden md:block">
